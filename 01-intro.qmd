...
-   About Wei:
    ...
    -   Principal Librarian, Instruction and Learning Services, SMU Libraries.

    -   Have been with SMU over 17 years. This is my 3rd run of R workshops!
...
-   Summary functions like `mean` needs you to include argument called `na.rm` on how you want it to be handled.
...
Go to the course website and go to the ['Dataset'](https://smu-libraries.github.io/r-socsci/dataset.html) tab to download the data file and information about this WVS data

Download this CSV and save it under your `data` folder in your R project!

## Packages in R (for additional functionalities)
...
-   Can only contain a predefined set of values, known as `levels`. By default, R sorts levels in alphabetical order (but we can specify a custom order, as we'll see shortly)
