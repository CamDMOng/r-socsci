---
title: "Session 4: Basic Inferential Stats in R: Correlation, T-Tests, and ANOVA"
...
The variance will be easier to see when we visualize it as well. Here the two groups have somewhat different spreads (the urban group is more variable), which suggests the variances may not be homogeneous — a good reason to use Welch's t-test below.
...
::: columns
::: {.column width="50%"}
$H_0$: There is **no** significant difference in mean secular values between urban and rural residents.
:::

::: {.column width="50%"}
$H_1$: There is a significant difference in mean secular values between urban and rural residents.
:::
:::
...
The results indicate that the p-value is less than the significance level of 0.05, suggesting that there IS a significant difference in variance across the groups. Consequently, the assumption of homogeneity of variances is NOT satisfied.
