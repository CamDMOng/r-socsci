...
4.  Show and tell - Using Quarto to generate slides or report in R!
...
# put the age groups in ascending order so the youngest group (18-28)
# becomes the reference category
wvs_cleaned <- wvs_cleaned |>
    mutate(age_group = factor(age_group,
                              levels = c("18-28", "29-44", "45-60", "61+")))
...
> A linear regression analysis was conducted to examine how age groups predict life satisfaction. With the youngest age group (18-28) as the reference group (intercept = 7.02, SE = 0.06), the pattern was mixed. The 29-44 age group scored 0.14 units lower, though this difference was not statistically significant (SE = 0.07, p = 0.065). The 45-60 age group scored 0.18 units lower (SE = 0.08, p = 0.023), while the oldest 61+ age group scored 0.22 units higher (SE = 0.11, p = 0.044) than the reference group.

> The model was statistically significant (F(3, 5098) = 5.86, p < 0.001) but explained less than 1% of the variance in life satisfaction (R² = 0.003, Adjusted R² = 0.003).
